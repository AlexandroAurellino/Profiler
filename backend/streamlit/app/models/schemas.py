...
# ==========================================
# 5. ADMIN / CONFIGURATION MODELS
# ==========================================

class CourseUpdate(BaseModel):
    """Payload for adding or editing a course."""
    code: str
    name: str
    sks: int = Field(..., ge=1, le=6)

class RelevanceUpdate(BaseModel):
    """Payload for updating a course's AHP weights."""
    code: str
    type: CriteriaType
    weights: Dict[ProfileType, float] # e.g. {"AI": 0.8, "PSD": 1.0}
